...
TCTF_LAST_RECV_ACK|uint8_t|(uint8_t)gs_driver->latest_info->rx.rec_status|65|0|8||2.10|TC Transer Frame DS処理結果||
...
TLM_TX_PORT_TYPE|uint8_t|(uint8_t)gs_driver->tlm_tx_port_type|72|0|8||2.11|TLM の送信情報がUARTのものかGSのものか||
