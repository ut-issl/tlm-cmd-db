...
OBC_MM_STS|uint8_t||39|0|1|||
OBC_MM_OPSMODE_PREV|||39|1|7|||
OBC_TDSP_CURRENT_ID|uint16_t|TDSP_info->task_list_id|40|0|16|||||
OBC_TCTF_LAST_RECV_ACK|uint8_t|(uint8_t)gs_driver->latest_info->rx.rec_status|42|0|8||2.1|TC Transer Frame 受信処理結果||
